...
class Order_quoteController extends Zend_Controller_Action {
	...
	public function indexAction(){
		try{
			...
			$collumns = array("QUOTE_NO","CUSTOMER_NAME","CEREMONY_DATE","ADDRESS","TABLE_FOR_WEDDING","TABLE_FOR_BREAKFAST","TABLE_FOR_LUNCH","TABLE_FOR_DINNER","TOTAL_AMOUNT","STATUS");
			$link=array(
