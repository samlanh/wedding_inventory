...
class Order_indexController extends Zend_Controller_Action {
	...
	public function indexAction(){
		try{
			...
			$collumns = array("ORDER NO","CUSTOMER","DATE CEREMONY","NUMBER TABLE WEDDING FOOD","NUMBER TABLE BREAKFAST FOOD","NUMBER TABLE LUNCH FOOD","NUMBER TABLE DINNER FOOD","STATUS");
			$link=array(
