...
class User_IndexController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
      $db_user=new Application_Model_DbTable_DbUsers();
        ...
        $collumns = array("LASTNAME_FIRSTNAME","USER_NAME","STATUS");
        $link=array(
        		'module'=>'user','controller'=>'index','action'=>'edited',
        );
        $this->view->list=$list->getCheckList(0, $collumns, $rs_rows,array('name'=>$link,'username'=>$link));
    }
    ...
    public function editedAction()
    {
        ...
        $db_user=new Application_Model_DbTable_DbUsers();
       // print_r($db_user->getUserEdit($us_id));exit();
