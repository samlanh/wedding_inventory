...
{        
	...
	public function showDeleteBuntton($url_delete) {
    	...
    	$deleteButton = '&nbsp;<a href="#" onClick="deleteRecord(\''.$url_delete.'\')">'
						.'<img alt="" src="'.BASE_URL.'/images/icon/cross.png">'
						.$tr->translate("DELETE")
						.'</a>';
		return $deleteButton;
    }
    ...
    public function showMergeBuntton($url_merge) {
    	defined('BASE_URL')	|| define('BASE_URL', Zend_Controller_Front::getInstance()->getBaseUrl());
    	$tr = Application_Form_FrmLanguages::getCurrentlanguage();
    
    	$mergeButton = '&nbsp;<a href="#" class="btn-action" onClick="mergeRecord(\''.$url_merge.'\')">'
    			.'<img alt="" src="'.BASE_URL.'/images/icon/merge-cells-icon.png"><b>'
    					.$tr->translate("MERGE ORDER")
    					.'</b></a>';
    	return $mergeButton;
    }
